...
const ListAppreciationProducts = React.lazy(() =>
  import("./views/appreciation_product/ListAppreciationProduct")
);
const AppreciationProductDetail = React.lazy(() =>
  import("./views/appreciation_product/AppreciationProductDetail")
);
const AddAppreciationProduct = React.lazy(() =>
  import("./views/appreciation_product/AddAppreciationProduct")
);
...
const routes = [
  ...
  },
  {
    ...
    name: "Appreciation Products",
    component: ListAppreciationProducts,
    permission: [Roles.ADMIN],
    exact: true,
  },
  {
    path: "/appreciation-products/create",
    name: "Add Appreciation Product",
    component: AddAppreciationProduct,
    permission: [Roles.ADMIN],
    exact: true,
  },
  {
    path: "/appreciation-products/:id",
    name: "Appreciation Product Detail",
    component: AppreciationProductDetail,
    permission: [Roles.ADMIN],
    exact: true,
  },
  {
